                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Nome Produto</label>
                                <input type="text" class="form-control" name="editar_produto_nome"
                                    id="editar_produto_nome" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Categoria do Produto</label>
                                <input type="text" class="form-control" name="editar_produto_categoria"
                                    id="editar_produto_categoria" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label>Espécie</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control 2" name=editar_produto_custo"
                                    id="editar_produto_custo" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label>Lucro (percentual)</label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control" disabled name="editar_preco_sugerido"
                                    id="editar_preco_sugerido">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label>Preço de Venda</label>
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control 2" required name="editar_produto_preco_de_venda"
                                    id="editar_produto_preco_de_venda">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label>Lucro (em reais)</label>
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control 2" disabled required name="editar_produto_lucro"
                                    id="editar_produto_lucro">
                            </div>
                            <small class="form-text text-muted">Lucro estimado sem taxas e impostos.
                            </small>
                        </div>
