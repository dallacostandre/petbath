                        ...
                        <div class="card-body">
                            <center class="mt-4">
                                ...
                                <div class="row text-center justify-content-md-center">
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0)" class="link"><i class="mdi mdi-camera"></i>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="rua" name="rua" placeholder="Rua"
                                            value="@if (isset($endereco)) {{ $endereco[0]->cliente_rua }} @endif"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control numero" id="numero" name="numero"
                                            value="@if (isset($endereco)) {{ $endereco[0]->cliente_numero }} @endif"
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="complemento" name="complemento"
                                            ...
                                            value="@if (isset($endereco)) {{ $endereco[0]->cliente_complemento }} @endif"
                                            required>
                                    </div>
                                </div>
